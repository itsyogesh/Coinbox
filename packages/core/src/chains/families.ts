...
export const CHAIN_FAMILIES: Record<ChainFamily, ChainFamilyDefinition> = {
  bitcoin: {
    id: 'bitcoin',
    name: 'Bitcoin',
 ...
 */
export const FAMILY_CHAINS: Record<ChainFamily, string[]> = {
  bitcoin: ['bitcoin'],
 ...
 */
export function getFamilyForChain(chainId: string): ChainFamily | undefined {
  for (const [family, chains] of Object.entries(FAMILY_CHAINS)) {
    if (chains.includes(chainId)) {
      return family as ChainFamily;
    }
  }
  return undefined;
}
