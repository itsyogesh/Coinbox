...
export const ETHEREUM_TOKENS: TokenDefinition[] = [
  {
...
export const ARBITRUM_TOKENS: TokenDefinition[] = [
  {
...
export const OPTIMISM_TOKENS: TokenDefinition[] = [
  {
...
export const POLYGON_TOKENS: TokenDefinition[] = [
  {
